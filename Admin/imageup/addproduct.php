...
<div class="container" style=" margin-bottom: 50px;">
  ...
  <div class="container mt-5 mb-5" style="background: #002ca5cc; width: 700px;">
      ...
      <font style="color: #fff; font-weight: bold; font-size: 35px;margin-left: 100px;">Add Product</font>
        ...
        <br>
            ...
            <input type="text" placeholder="Add the Name of the Product" name="name" id="name">
            <br><br>

            <label for="code">Item Code :</label><br>
            <input type="text" placeholder="Add Item Code of the Product" name="code" id="code">
            <br><br>

 
            <label for="price">Price :</label><br>
            <input type="text" placeholder="Add Price of the Item" name="price" id="price">
            <br><br>

            <label for="qty">Discount :</label><br>
            <input type="text" placeholder="Add Discount" name="discount" id="qty">
            <br><br>
            ...
            <input type="text" id="description" placeholder="Add Description about Product" name="dis" style="height: 100px;">
            <br><br>
            <button type="submit" class="btn btn-add" name="submit">ADD</button>      
