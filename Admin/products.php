...
<html lang="en">
  ...
  <div class="modal fade" id="settings" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="home" id="home">
      ...
      <!-- products table -->
      <a href="imageup/addproduct.php"><button class="btn-add fas fa-plus">  Add New</button></a>
      <div class="search">
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <table class="table  mb-2">
                    ...
                    <?php 
                    	$query = "SELECT * FROM product inner join categories on product.catID = categories.catID";
                                            ...
                                            <table>
                                             <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-font"><?php echo $row['price']; ?></td>
                                                </tr>
                            ...
                            <div class="d-flex product-actions">
                              <div>
                                <button class="btn-view">
                                  <a href="#" data-toggle="modal" data-target="#myModal<?php echo $row['itemcode']; ?>" class="btn-view"><i class=" fas fa-eye"></i></a>
                                </button>
                              </div>
                              <div>
                               <a href="imageup/updateproduct.php"><button class="btn-confirm"><i class="far fa-edit"></i></button></a>
                              </div>
                              <div>
                                <form action="" method="post">
                                  <input type="hidden" name="productid" value="<?php echo $row['PID']; ?>">
                                  <button type="submit" class="btn-cancel" name="delete"><i class="fas fa-trash"></i></button>
                                </form>
                              </div>
