  ...
  <div class="modal fade" id="profile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <section>
        ...
        <section id="hero">
            <div class="hero-container">
                <div class="hero-logo">
                   <h1 class="font-weight-bold " style="font-size: 50px;">Your Cart</h1>
                </div>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    $total = 0;
                      ...
                      $query = "SELECT * FROM cart inner join product on cart.PID = product.PID WHERE CID = $cid ";
                            ...
                            <td>
                                ...
                                <img src="Admin/imageup/server/uploads/<?php echo $filenames[0];?>" width="145" height="98">
                                    ...
                                    <div class="des">
                                        ...
                                        <button type="submit" class="btn2" name="delete_cart">Remove</button>
                                        </form>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="counter">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <button name="updateqty" class="qty-update-btn"><i class="fas fa-pen-square"></i></button>
                                    </form>
                                </div>
                            </td>
                            <td>
                                <h6>Rs:<?php echo ($row['price'] * $row['qty']); ?></h6>
    ...
    <div class="col-lg-4 offset-lg-4">
        <div class="checkout">
            ...
            <a href="mymenu.php"class="proceed-btn  mt-3 mb-5">Go to Menu</a>
        </div>
    </div>
