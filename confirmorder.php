...
if(isset($_POST['submit'])){
    ...
    if(isset($_SESSION['cid'])){
        ...
        if(!empty($_POST['address2'])){
            ...
            $queryupdate = "UPDATE customer SET delivery_address = '$address2', delivery_city='$city2', delivery_state ='$state2' WHERE CID = $cid";
            $runupdate = mysqli_query($connection, $queryupdate) or die(mysqli_error());
        }

        $query = "insert into orders(PID, CID, date, time, qty, total, status) values('$pid','$cid', '$dt1', '$dt2', '$qty', '$total', 'pending')";
        ...
        $run3 = mysqli_query($connection, $query3) or die(mysqli_error());
