...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="pidie-0..8.js">
    ...
    <section class="form my-4 mx-5">
        <div class="container">
            <div class="row no-gutters" style="background: rgb(231, 226, 153); border-radius: 30px; box-shadow: 12px 12px 22px gray;">
                <div class="col-lg-5">
                    <img src="Pics/login3.jpg" class="img-fluid" alt=""  style="border-top-left-radius: 30px; border-bottom-left-radius: 30px; width:100%; height:700px;">
                </div>
                <div class="col-lg-7 px-5 pt-5">
                    <img src="Pics/logo.png" width="125" height="105">
                    <h4 class="mt-4 ml-5 align-content-center ml-5"><b>Register Here</b></h4>
                    <?php if($error_msg != ""){?>
                    ...
                    <form action="" method="post">
                        <div class="form-row">
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="Address" name="address" class="form-control my-3">
                                <input type="text" placeholder="Avenue" name="state" class="form-control my-3">
                                <input type="text" placeholder="Phone" name="phone" class="form-control my-3" pattern="07[0-2,4-8]{1}[0-9]{7}" maxlength="10">
                                <input type="password" placeholder="Password" id="pass" name="password" class="form-control my-3">
                            </div>
                           
                            
                            <div class="col-lg-5">
                                <input type="text" placeholder="Last-Name" name="lname" class="form-control my-3">
                                <input type="text" placeholder="City" name="city" class="form-control my-3">
                                <input type="text" placeholder="Postal-Code" name="zipcode" class="form-control my-3">
                                <!-- <input type="mail" placeholder="Usename" name="uname" class="form-control my-3 p-3"> -->
                                <input type="email" placeholder="E-mail" name="email" class="form-control my-3 p-3" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
                                <input type="password" placeholder="Confirm Password" id="cpass" name="cpass" class="form-control my-3 p-3">
                                <?php if($error !=""){ ?>
                                <p id="message" style="background-color:#ff4d4d;">
                                    <?php echo $error; ?>
                                </p>
                                <?php }?>
                       ...
                       <div class="form-row">
                            <div class="col-lg-7">
                               <button type="submit" name="submit" class="btn1 mt-3 mb-5 ml-5">Submit</button>
                           </div>
                        </div>                    
                       </div>
                      </form>
